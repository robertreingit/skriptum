...
Nun kann die logistische Regression eingeführt werden. Es liegt nun das folgende vor. Es wurden insgesamt $20$ Würfen von der zentralen Linie auf das Tor gemacht. Zehn der Würfe wurden direkt von der Torraumlinie (6m) und zehn Würfe aus dem Rückraum (8m). Es ergibt sich die folgende Verteilung der Würfe (siehe @fig-mlm-log-handball-prob-01).
...
Im Folgenden wird noch eine alternative Betrachtung der Logistischen Regression angewandt um das Verständnis noch einmal zu erweitern. Dazu wird ein Spezialfall des vorhergehenden Beispiels betrachtet indem nur Würfe aus der kurzen Distanz analysiert werden (siehe @fig-mlm-log-handball-prob-02)
