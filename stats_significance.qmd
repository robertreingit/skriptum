...
Können wir eigentlich den p-Wert und die Irrtumswahrscheinlichkeit in irgendeiner Form zusammenbringen? Ja, ganz klar wenn wir wissen das die beobachtete Statistik einen p-Wert von kleiner $\alpha$ hat, dann haben wir ein statistisch signifikanten Ergebnis. Wenn euch das nicht auf anhieb klar ist, dann schaut euch noch mal @fig-stats-sig-p-value-01 an.

Da der p-Wert eines der am meisten missverstandenen Konzepte ist, hier noch mal ein paar Statements und Erklärungen.
...
In @fig-stats-sig-altman ist ein kurzer Abschnitt aus @altman1995 abgebildet, der noch mal auf eine weiter Missinterpretation eines statisisch signifikanten Ergebnisses eingeht.
...
Kurz gesagt, wenn wir kein statistisches Ergebnisse gefunden haben, bedeutet dies nicht, das es keinen Unterschied gibt. Tatsächlich wird der beobachtete Wert praktisch nie exakt $=0$ sein. Der die Abwesenheit von Evidenz ist nicht gleich die Evidenz für Abwesenheit. 
