...
In @fig-stats-sig-decision-regions ist die Entscheidungsregel noch einmal graphisch anhand der Verteilung dargestellt. Wir haben unsere Stichprobenverteilung unter der $H_0: \mu = \Delta = 0$ und schneiden rechts und links jeweils einen Bereich der Verteilung ab. Diesen Bereich bezeichnen wir als kritischen Bereich. Wenn unser beobachteter Wert im kritischen Bereich liegt, sehen wir dies als Evidenz gegen die Korrektheit der Annahme $H_0$ an.
