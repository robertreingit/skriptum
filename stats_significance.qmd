...
Die Verteilungsfunktion gibt die Wahrscheinlichkeit $P$ an, dass eine Zufallsvariable $X$ einen Wert kleiner oder gleich einem bestimmten Wert $x$ annimmt, formal $P(X \seq x)$. Sie wird daher auch als kumulative Verteilungsfunktion bezeichnet.
:::

Diese Definition ist nicht ganz so einfach nachzuvollziehen.
