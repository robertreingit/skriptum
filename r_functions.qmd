...
Diese Informationstiefe sollte für die allermeisten Anwendungsfälle ausreichen. Sollten sich doch einmal weitere Fragen ergeben dann sind die Abschnitte zu Funktionen in `R`, in [R4DS](https://r4ds.hadley.nz/functions.html) und [Advanced R](https://adv-r.hadley.nz/functions.html) zu empfehlen.
