...
Nachdem im vorhergehenden Kapitel gezeigt wurde, wie eine Regressionsgerade an einen Datensatz angepasst werden kann, stellt sich nun die Frage, ob die Regressionsgerade tatsächlich einen relevanten Zusammenhang zwischen den beiden Variablen $X$ und $Y$ beschreibt. Der Ansatz der Minimierung der Residuen wird in jedem Fall zu einem Ergebnis führen, nur ob diese Gerade dadurch *nützlich* wird kann damit noch nicht beantwortet werden.
