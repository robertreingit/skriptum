...
Die Beobachtungseinheit \index{Beobachtungseinheit} \index{observational unit} ist das Objekt, an der eine Messung vorgenommen wird. Die Beobachtungseinheit kann gleich der experimentellen Einheit sein, kann sich aber auch von dieser unterscheiden.
:::
...
Eine Replikation ist die Wiederholung der Versuchssituation durch mehrere experimentelle Einheiten. Replikationen sind daher zwei oder mehr Versuche, die bei denselben Bedingungen der experimentellen Kondition mit **unterschiedlichen** experimentellen Einheiten durchgeführt werden. Im englischen wird dieser Wiederholung der Kondition mit mehrern EUs als *replications* bezeichnet.
:::
