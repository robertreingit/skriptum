...
Wenn Modell miteinander verglichen werden, die sich nur um einen Parameter voneinander unterschieden, d.h. $\Delta p = 1$, dann ist der beobachtete $F$-Test äquivalent zum $t$-Wert den unter `summary()` angezeigt wird. Der $F$-Wert ist gleich dem quadrierten $t$-Wert.
