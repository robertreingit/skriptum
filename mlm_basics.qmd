...
Um diesen Zusammenhang besser zu verstehen ist zunächst eine kleine Detour notwendig. Wir erstellen uns eine neue Prädiktorvariable $x_1^*$. Wir erhalten $x_1^*$ indem wir eine Regression von $x_1$ auf $x_2$ berechnen. Also das Modell: 
