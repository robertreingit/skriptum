...
Der Name variance inflation factor deutet dabei schon auf den Effekt von Multikollinearität hin. Durch die Korrelation der Variablen untereinander kommt es zu einer *Inflation der Varianzen*. D.h. die Standardfehler der Modellparameter werden vergrößert was dazu führen kann, dass die Modellkoeffizienten keine statistische Signifikanz aufweisen obwohl ein klarer Zusammenhang zwischen der Prädiktorvariablen und der abhängigen Variablen besteht.
...
### Wenn Prädiktorvariablen $X_j$ sich maskieren 
