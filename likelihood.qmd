...
Seien $x$ die beobachteten Daten und $\theta$ ein unbekannter Parameter eines statistischen Modells mit Likelihood-Funktion $\mathcal{L}(\theta)$. Der **Maximum-Likelihood-Schätzer (ML-Schätzer)** ist derjenige Parameterwert $\hat{\theta}$, der die Likelihood maximiert:
